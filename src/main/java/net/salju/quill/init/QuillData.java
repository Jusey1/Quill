...
public class QuillData {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<BundleBomb>> BOMB = register("bundle_holding_bomb", (stuffs) -> {return stuffs.persistent(BundleBomb.CODEC).networkSynchronized(BundleBomb.STREAM_CODEC).cacheEncoding();});
